...
class CollectionViewModel : ViewModel() {
    ...
    fun loadCollection() {
        val recipes = mutableListOf(
            Recipe(R.drawable.col1_rep1,"Roast beef with red wine & banana shallots ",5,"Easy",80,"Enjoy each morning the delicious taste of breakfast",R.drawable.profile4,"Anna",""),
            Recipe(R.drawable.col1_rep2,"Pot-roast beef with French onion gravy", 5,"Easy",135,"Enjoy each morning the delicious taste of breakfast",R.drawable.profile3,"Thanh Lam",""),
            Recipe(R.drawable.col1_rep3,"Bacon & roast onion salad", 5,"Easy",30,"Enjoy each morning the delicious taste of breakfast" ,R.drawable.profile4,"Anna",""),
        )
        ...
        val recipes2 = mutableListOf(
            ...
            Recipe(R.drawable.col3_rep3,"Baked Banana-Nut Oatmeal Cups", 4,"Easy",65,"Enjoy each morning the delicious taste of breakfast",R.drawable.profile3,"Thanh Lam","" ),
        )
