...
import com.example.foodlife.databinding.ItemSelectCollectionBinding

class SelectCollectionAdapter(private val listener: (BottomDialogOption) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ItemViewHolder(private val itemBottomDialog: ItemSelectCollectionBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding =
            ItemSelectCollectionBinding.inflate(
